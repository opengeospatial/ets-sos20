...
mvn install
cd target 
unzip ets-sos20-2.0.0-r18.zip -d $TE_BASE/scripts/
...
echo "  "
echo "TEAM Engine ($te_tag) and the ets-sos20-2.0.0-r18 have been installed."
echo "  "
echo " UNIX/OS users - You can run the test with the following commands: "
echo "   export TE_BASE=$TE_BASE"
echo "   $base/teamengine/te_install/bin/unix/test.sh -source=sos/2.0.0/ctl/SOS_ETS.xml"
echo "  "
echo " Windows users - You can run the test with the following commands:"
echo "   set TE_BASE=$TE_BASE"
echo "   $base/teamengine/te_install/bin/windows/test.bat -source=sos/2.0.0/ctl/SOS_ETS.xml"
echo "  "
